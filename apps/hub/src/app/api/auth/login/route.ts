// app/api/auth/login/route.ts — Hub Auth (SSO Entry Point)
// Login terpusat di Hub — cookie set dengan domain .roisanwr.me agar berlaku di semua app
...
export async function POST(req: Request) {
  try {
    ...
    // 1. Cari user by email atau username
    ...
    // 6. Set cookies — domain .roisanwr.me agar berlaku di semua subdomain (SSO)
